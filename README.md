...
OBSERVER is an add-on for web browsers that captures the DOM structures and user actions in real-time. Clicks, inputs, and scrolling are all recorded, along with contextual information that is extracted and exported in JSON format.
...
- [very useful checklist once you think you are done](https://developer.chrome.com/docs/extensions/mv3/mv3-migration-checklist/)
